<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="Register.aspx.vb" Inherits="WebApplication1.Register" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="body" style="width:50%; ">
        ...
        <table style="font-size:26px; margin:auto; ">
            ...
            <tr>
                <td class="auto-style1">
                    <asp:Label ID="Label7" runat="server" Text="Subscription type: "></asp:Label>
                </td>
                <td>
                    <asp:DropDownList ID="DropBox" Font-Size="Large" Width ="197px" runat="server" >
